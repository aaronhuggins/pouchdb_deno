...
type PluginSignature = [string] | [string,string] | [string,string,string] | [string,string,string,string]
...
if (pouchDBType !== 'object' || (pouchDBType === 'object' && !globalAnyRef.PouchDB.__iAmSoFake__)) {
